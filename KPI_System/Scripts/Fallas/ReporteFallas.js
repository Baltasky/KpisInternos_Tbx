...
var TablaReporteVentas = function () {
    ...
    var exportButtons = () => {
        const documentTitle = 'Reporte Fallas';
...
function GetUnidadesOperativas(DivisionesSelected) {
    ...
    $.ajax({
        url: "/Fallas/GetUnidadesOperativas",
        type: "post",
        data: {
            TipoPeticion: 1,
